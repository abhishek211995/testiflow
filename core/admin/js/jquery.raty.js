...
(function (root, factory) {
  ...
  $.raty = {
    ...
    single: false,
    space: true,
    starHalf: `${tfadminVars.admin_images_path}/star-half.png`,
    starOff: `${tfadminVars.admin_images_path}/star-off.png`,
    starOn: `${tfadminVars.admin_images_path}/star-on.png`,
    starType: "img",
    target: undefined,
    targetFormat: "{score}",
    targetKeep: false,
