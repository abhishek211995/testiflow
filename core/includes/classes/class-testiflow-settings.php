 ...
 * 
 * TESTIFLOW->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Testiflow_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		TESTIFLOW
 * @subpackage	Classes/Testiflow_Settings
...
class Testiflow_Settings{
	...
	/**
	 * Our Testiflow_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = TESTIFLOW_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'TESTIFLOW/settings/get_plugin_name', $this->plugin_name );
	}
}
